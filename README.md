...
A client library to connect to SHMN Core RPC in JavaScript.

## Get Started

shmnd-rpc.js runs on [node](http://nodejs.org/), and can be installed via [npm](https://npmjs.org/):

```bash
npm install shmnd-rpc
```
